...
def get_reset_password_token() -> str:
    """
    Route POST /reset_password : génère un token pour réinitialiser
    le mot de passe. Retourne un JSON avec le token ou 403 si l'email
...
def update_password() -> str:
    """
    Route PUT /reset_password : met à jour le mot de passe utilisateur.
    Nécessite email, reset_token et new_password.
    Retourne un message de confirmation ou 403 si échec.
    """
    email = request.form.get("email")
